...
const EXPERIENCES = [
  {
    ...
    items: [
      ...
      'Architected <strong class="text-[#FEF3C7]">GSC AI Search Engine</strong> (Neo4j + Qdrant + AWS Bedrock) on private AWS VPC — sub-300ms cross-region retrieval.',
      'Migrated WebSocket services to Azure Container Apps — cut compute costs <strong class="text-[#FEF3C7]">60%+</strong> vs always-on VMs.',
      'Built <strong class="text-[#FEF3C7]">Gruve TechGenie</strong> IT voice agent — 40% reduction in ticket resolution time across 3 enterprise clients.',
    ],
  },
  {
    ...
    items: [
      ...
      'Achieved <strong class="text-[#FEF3C7]">91% diagnostic accuracy</strong> across 5,000+ sessions, $150K annual savings.',
  ...
  },
  {
    ...
    items: [
      'Fast UNet + VAE optimisations for SDXL + ControlNet — <strong class="text-[#FEF3C7]">1–2s inference</strong>, 80% cost reduction, 50K+ images/month.',
      'Gradient checkpointing + mixed-precision — 60% GPU memory reduction, <strong class="text-[#FEF3C7]">$30K/month</strong> AWS savings.',
    ],
  },
  {
    ...
    items: [
      'OCR, segmentation & detection for 8 manufacturing clients — <strong class="text-[#FEF3C7]">92% accuracy</strong> at 0.25s inference.',
      'SSE replacement of polling — 90% API cost cut, <strong class="text-[#FEF3C7]">$2M annual savings</strong> across 15+ global facilities.',
    ],
  },
];
